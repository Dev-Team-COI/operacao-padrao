    ...
    <body>
        ...
        <div class="page-container">
            ...
            <div class="page-sidebar">
                <!-- START X-NAVIGATION -->
                    <?php require_once("menu-empilhadeira.php"); ?>
                
                     <li class="active">
                        <a href="empilhadeira.php"><span class="fa fa-desktop"></span> <span class="xn-text">Inicial</span></a>                        
                    </li>    
    
                    <li class="xn-openable">
                        <a href="tables.html"><span class="fa fa-table"></span> <span class="xn-text">Cadastro</span></a>
                        <ul>                            
                            <li><a href="passagem-empilhadeira.php"><span class="fa fa-align-justify"></span> Passagem de Serviço</a></li>
                            <li><a href="table-export.html"><span class="fa fa-download"></span>Formação de Pilha</a></li> 
        ...
        <div class="message-box animated fadeIn" data-sound="alert" id="mb-signout">
            <div class="mb-container">
                <div class="mb-middle">
                    ...
                    <div class="mb-footer">
                        <div class="pull-right">
                            <a href="php/logout.php" class="btn btn-success btn-lg">Sim</a>
